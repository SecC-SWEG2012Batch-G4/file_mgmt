...
->Ephratah Wodajo..................0249/12          ->Fatima Abayneh...0296/12                      ->Firdews Abrar.....0296/12
...
Hos.hos_doc={"DR.Firdews Abrar",27,'f',"General Doctor","(Monday-Thursday)=4:00am-11:30pm,(Friday and Saturday)=2:30am-6:00am"};
        ...
        cin>>p[i+c].dateadd.yy;
        out<<"\nAppointment date : "<<p[i+c].dateadd.dd<<"/"<<p[i+c].dateadd.mm<<"/"<<p[i+c].dateadd.yy;
  ...
  cout<<"\n\n-----------------------Personal Information Registration For Patient------------------------"<<endl;
    ...
    cin.ignore();
     ...
     out<<"\nBirthday : "<<p[i+c].date<<"/"<<p[i+c].month<<"/"<<p[i+c].year;
...
p[i+c].height2=p[i+c].height*p[i+c].height;
p[i+c].bmi= p[i+c].weight/p[i+c].height2;
